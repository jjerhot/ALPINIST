...
baseLegendPast90CL::usage="Basic setup for 90CL legend"
baseLegendExt90CL::usage="Extended setup for 90CL legend"
baseLegendAll90CL::usage="Setup for all experiments 90CL legend"
baseLegendNow90CL::usage="Setup for NA62 2021 90CL legend"
yLabelxMass::usage=
"Setup for axis labels. ylabel as input, xlabel fixed as ALP mass."
...
baseLegendPast90CL=LineLegend[{Opacity[0.6,Darker[Gray,0.3]],Lighter[Blue,0.8],Lighter[Orange,0.8]},{"CHARM","NA62 Run1 (\!\(\*StyleBox[\"K\",FontSlant->\"Italic\"]\)\[RightArrow]\[Pi]\[Nu]\[Nu], \!\(\*SuperscriptBox[StyleBox[\"\[Pi]\",FontSlant->\"Italic\"], \"0\"]\)\[RightArrow]inv)","LHCb"},Spacings-> 0.15,LabelStyle->baseStyleLeg90CL];
baseLegend90CL=LineLegend[{{Thickness[0.05],Opacity[0.6,Darker[Gray,0.3]]},Opacity[0.7,Darker[Red,0.6]],Opacity[0.8,Black],{Thickness[0.05],Lighter[Blue,0.8]},{Thickness[0.05],Lighter[Orange,0.8]}},{"CHARM","HIKE (5\[Times]\!\(\*SuperscriptBox[\(10\), \(19\)]\))","SHADOWS (5\[Times]\!\(\*SuperscriptBox[\(10\), \(19\)]\))","NA62 Run1 (\!\(\*StyleBox[\"K\",FontSlant->\"Italic\"]\)\[RightArrow]\[Pi]\[Nu]\[Nu], \!\(\*SuperscriptBox[StyleBox[\"\[Pi]\",FontSlant->\"Italic\"], \"0\"]\)\[RightArrow]inv)","LHCb"},Spacings-> 0.15,LabelStyle->baseStyleLeg90CL];
...
baseLegendAll90CL=LineLegend[{Opacity[0.5,Darker[Green,0.5]],Opacity[0.5,Red],Opacity[0.7,Darker[Red,0.6]],Opacity[0.8,Black],Opacity[0.5,Lighter[RGBColor[0.05,0.2,0.75],0.3]],{Thickness[0.05],Lighter[Orange,0.8]},{Thickness[0.05],Opacity[0.6,Darker[Gray,0.3]]},{Thickness[0.05],Lighter[Blue,0.8]}},{"DarkQuest","DUNE","HIKE (5\[Times]\!\(\*SuperscriptBox[\(10\), \(19\)]\))","SHADOWS (5\[Times]\!\(\*SuperscriptBox[\(10\), \(19\)]\))","SHiP","LHCb","CHARM","NA62 Run1 (\!\(\*StyleBox[\"K\",FontSlant->\"Italic\"]\)\[RightArrow]\[Pi]\[Nu]\[Nu], \!\(\*SuperscriptBox[StyleBox[\"\[Pi]\",FontSlant->\"Italic\"], \"0\"]\)\[RightArrow]inv)"},Spacings-> 0.15,LabelStyle->baseStyleLeg90CL];
baseLegendNow90CL=LineLegend[{{Thickness[0.05],Opacity[0.6,Darker[Gray,0.3]]},Opacity[0.7,Darker[Red,0.6]],{Dashed,Opacity[0.7,Darker[Red,0.6]]},{Dotted,Opacity[0.7,Darker[Red,0.6]]},{Thickness[0.05],Lighter[Blue,0.8]},{Thickness[0.05],Lighter[Orange,0.8]}},{"CHARM","NA62 (1.4\[Times]\!\(\*SuperscriptBox[\(10\), \(17\)]\))","NA62 \!\(\*
StyleBox[\"ee\",\nFontSlant->\"Italic\"]\) (1.4\[Times]\!\(\*SuperscriptBox[\(10\), \(17\)]\))","NA62 \[Mu]\[Mu] (1.4\[Times]\!\(\*SuperscriptBox[\(10\), \(17\)]\))","NA62 Run1 (\!\(\*StyleBox[\"K\",FontSlant->\"Italic\"]\)\[RightArrow]\[Pi]\[Nu]\[Nu], \!\(\*SuperscriptBox[StyleBox[\"\[Pi]\",FontSlant->\"Italic\"], \"0\"]\)\[RightArrow]inv)","LHCb"},Spacings-> 0.15,LabelStyle->baseStyleLeg90CL];
