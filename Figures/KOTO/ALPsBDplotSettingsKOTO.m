...
BeginPackage["ALPsBDplotSettingsKOTO`"]
...
plotSettings90CLKOTOpnn::usage="setup for KOTO 90CL plots"
plotSettings90CLKOTOexclPnn::usage="setup for KOTO higher statistics excluding Pnn region 90CL plots"
plotSettings90CLKOTO2pnn::usage="setup for KOTO stage 2 90CL plots"
plotSettings90CLKOTOdump::usage="setup for KOTO in dump mode 10x statistics 90CL plots"
plotSettings90CLKOTO2dump::usage="setup for KOTO stage 2 in dump mode 10x statistics 90CL plots"
...
baseStyleLeg90CL={FontSize-> 14,FontFamily->"CMU Serif",SingleLetterItalics-> False,FontColor-> Black};
...
plotSettings90CL={PlotRange->{{0.04,1.},{1*10^-6,3*10^-1},{10^-8,Full}},PlotRangePadding-> None,ScalingFunctions->{"Log10","Log10"},ImageSize->Medium,BaseStyle-> Thickness[0.005],FrameTicks->{{LogTick[-10,-1],None},{LogTick[-2,0],None}},LabelStyle->Directive[baseStyle]};
plotReducedSettings90CL={PlotRange->{{0.4,2.},{1*10^-7,1*10^-2},{10^-8,Full}},PlotRangePadding-> None,ScalingFunctions->{"Log10","Log10"},ImageSize->Medium,BaseStyle-> Thick,FrameTicks->{{LogTick[-7,-2],None},{LogTick[-4,0],None}},LabelStyle->Directive[baseStyle]};
...
plotSettings90CLCHARM={Contours->{2.3},ContourShading->{Transparent,Opacity[0.25,Darker[Gray,0.2]]},ContourStyle->None,Evaluate[plotSettings90CL]};
plotSettings90CLNuCal={Contours->{3.6},ContourShading->{Transparent,Opacity[0.25,Darker[Gray,0.2]]},ContourStyle->None,Evaluate[plotSettings90CL]};
...
plotSettings90CLE137={Contours->{2.3},ContourShading->{Transparent,Opacity[0.25,Darker[Gray,0.2]]},ContourStyle->Transparent,Evaluate[plotSettings90CL]};
