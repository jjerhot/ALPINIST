...
plotSettings90CL={PlotRange->{{0.04,1.},{1*10^-6,3*10^-1},{10^-8,Full}},PlotRangePadding-> None,ScalingFunctions->{"Log10","Log10"},ImageSize->Medium,BaseStyle-> Thickness[0.005],FrameTicks->{{LogTick[-7,1],None},{LogTick[-2,0],None}},LabelStyle->Directive[baseStyle]};
